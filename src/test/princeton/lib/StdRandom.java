...
public final class StdRandom {
    ...
    public static void main(String[] args) {
        ...
        princeton.lib.StdOut.println("seed = " + StdRandom.getSeed());
        for (int i = 0; i < N; i++) {
            princeton.lib.StdOut.printf("%2d "  , uniform(100));
            princeton.lib.StdOut.printf("%8.5f ", uniform(10.0, 99.0));
            princeton.lib.StdOut.printf("%5b "  , bernoulli(.5));
            princeton.lib.StdOut.printf("%7.5f ", gaussian(9.0, .2));
            princeton.lib.StdOut.printf("%2d "  , discrete(t));
            princeton.lib.StdOut.println();
        }

        String[] a = "A B C D E F G".split(" ");
        for (String s : a)
            princeton.lib.StdOut.print(s + " ");
        princeton.lib.StdOut.println();
    }
