...
public final class StdStats {
   ...
   /**
    ...
    public static void plotPoints(double[] a) {
        int N = a.length;
        princeton.lib.StdDraw.setXscale(0, N-1);
        princeton.lib.StdDraw.setPenRadius(1.0 / (3.0 * N));
        for (int i = 0; i < N; i++) {
            princeton.lib.StdDraw.point(i, a[i]);
        }
    }
   ...
   /**
    ...
    public static void plotLines(double[] a) {
        int N = a.length;
        princeton.lib.StdDraw.setXscale(0, N-1);
        princeton.lib.StdDraw.setPenRadius();
        for (int i = 1; i < N; i++) {
            princeton.lib.StdDraw.line(i-1, a[i-1], i, a[i]);
        }
    }
   ...
   /**
    ...
    public static void plotBars(double[] a) {
        ...
        princeton.lib.StdDraw.setXscale(0, N-1);
        for (int i = 0; i < N; i++) {
            princeton.lib.StdDraw.filledRectangle(i, a[i]/2, .25, a[i]/2);
        }
    }
   ...
   /**
    ...
    public static void main(String[] args) {
        ...
        princeton.lib.StdOut.printf("       min %7.3f\n", min(a));
        princeton.lib.StdOut.printf("      mean %7.3f\n", mean(a));
        princeton.lib.StdOut.printf("       max %7.3f\n", max(a));
