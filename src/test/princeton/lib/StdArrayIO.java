...
public class StdArrayIO {
    ...
    public static double[] readDouble1D() {
        int N = princeton.lib.StdIn.readInt();
        double[] a = new double[N];
        for (int i = 0; i < N; i++) {
            a[i] = princeton.lib.StdIn.readDouble();
        }
        return a;
    }
    ...
    public static void print(double[] a) {
        int N = a.length;
        princeton.lib.StdOut.println(N);
        for (int i = 0; i < N; i++) {
            princeton.lib.StdOut.printf("%9.5f ", a[i]);
        }
        princeton.lib.StdOut.println();
    }
    ...
    public static double[][] readDouble2D() {
        int M = princeton.lib.StdIn.readInt();
        int N = princeton.lib.StdIn.readInt();
        double[][] a = new double[M][N];
        for (int i = 0; i < M; i++) {
            for (int j = 0; j < N; j++) {
                a[i][j] = princeton.lib.StdIn.readDouble();
            }
        }
        return a;
    }
    ...
    public static void print(double[][] a) {
        int M = a.length;
        int N = a[0].length;
        princeton.lib.StdOut.println(M + " " + N);
        for (int i = 0; i < M; i++) {
            for (int j = 0; j < N; j++) {
                princeton.lib.StdOut.printf("%9.5f ", a[i][j]);
            }
            princeton.lib.StdOut.println();
        }
    }
    ...
    public static int[] readInt1D() {
        ...
        int[] a = new int[N];
        for (int i = 0; i < N; i++) {
            a[i] = princeton.lib.StdIn.readInt();
        }
        return a;
    }
    ...
    public static void print(int[] a) {
        ...
        princeton.lib.StdOut.println(N);
        for (int i = 0; i < N; i++) {
            princeton.lib.StdOut.printf("%9d ", a[i]);
        }
        princeton.lib.StdOut.println();
    }
    ...
    public static int[][] readInt2D() {
        ...
        for (int i = 0; i < M; i++) {
            for (int j = 0; j < N; j++) {
                a[i][j] = princeton.lib.StdIn.readInt();
            }
        }
        return a;
    }
    ...
    public static void print(int[][] a) {
        ...
        for (int i = 0; i < M; i++) {
            for (int j = 0; j < N; j++) {
                princeton.lib.StdOut.printf("%9d ", a[i][j]);
            }
            princeton.lib.StdOut.println();
        }
    }
    ...
    public static boolean[] readBoolean1D() {
        ...
        for (int i = 0; i < N; i++) {
            a[i] = princeton.lib.StdIn.readBoolean();
        }
        return a;
    }
    ...
    public static void print(boolean[] a) {
        ...
        princeton.lib.StdOut.println(N);
        for (int i = 0; i < N; i++) {
            if (a[i]) princeton.lib.StdOut.print("1 ");
            else      princeton.lib.StdOut.print("0 ");
        }
        princeton.lib.StdOut.println();
    }
    ...
    public static boolean[][] readBoolean2D() {
        ...
        for (int i = 0; i < M; i++) {
            for (int j = 0; j < N; j++) {
                a[i][j] = princeton.lib.StdIn.readBoolean();
            }
        }
        return a;
    }
   ...
   /**
    ...
    public static void print(boolean[][] a) {
        ...
        for (int i = 0; i < M; i++) {
            for (int j = 0; j < N; j++) {
                if (a[i][j]) princeton.lib.StdOut.print("1 ");
                else         princeton.lib.StdOut.print("0 ");
            }
            princeton.lib.StdOut.println();
        }
